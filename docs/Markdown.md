...
<pre>Biçimlendirilmemiş yazı</pre>

<small>Küçük yazı</small>

Bu bir <sub>altindis</sub>

Bu bir <sup>üstindis</sup>
...
[Satır içi bağlantı](https://google.com)

[Başlıkla satır içi bağlantı](https://google.com "Google")

[İsme göre referans bağlantı][link1]

[Numaraya göre referans bağlantı][1]

[Referansın kendisi]

[link1]: https://google.com
[1]: https://google.com
[referansın kendisi]: https://google.com
...
Bu bir `satır içi kod`

```javascript
const topla = (sayi1, sayi2) => sayi1 + sayi2;
const toplam = topla(1, 2);
...
!> **Önemli** Sık karşılaşılan `java.lang.NullPointerException` hatasını almamak
için referanslarınızı kontrol etmeyi unutmayın.

?> **İpuçu** Ekrana çıktı vermek için `print()` fonksiyonunu kullanabilirsiniz.
...
| Sola Hizalı | Ortaya Hizalı | Sağa Hizalı | Kesintisiz&nbsp;Başlık |
| ----------- | :-----------: | ----------: | ---------------------- |
| A1          |      A2       |          A3 | A4                     |
| B1          |      B2       |          B3 | B4                     |
| C1          |      C2       |          C3 | C4                     |
...
<kbd>&uarr;</kbd> Yukarı Ok

<kbd>&darr;</kbd> Aşağı Ok

<kbd>&larr;</kbd> Sola Ok

<kbd>&rarr;</kbd> Sağa Ok
...
Tüm emojilerin olduğu liste: [Emoji Cheat Sheet](https://www.webpagefx.com/tools/emoji-cheat-sheet/)
